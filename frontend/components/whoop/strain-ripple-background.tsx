...
const ACTIVE_RGB: [number, number, number] = [1, 149, 233]; // --metric-strain / --whoop-accent
...
/**
 * Strain-page-only decorative background — same activation/visibility
 * mechanics as the sleep/recovery pages' particle fields, with a fixed
 * WHOOP-blue activation color (strain doesn't have a red/yellow/green
 * zone concept the way recovery does, so there's nothing to vary it by).
 */
export function StrainRippleBackground() {
